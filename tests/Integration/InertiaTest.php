...
final class InertiaTest extends TestCase
{
    ...
    public function test_location_response_for_inertia_requests(): void
    {
        $this->container->singleton(
            Request::class,
            fn() => $this->createInertiaRequest(Method::GET, uri: "/"),
        );
    ...
    {
        $response = $this->http->get(
            uri([TestController::class, "nonInertiaPage"]),
        );
    ...
    public function test_mergeable_props_can_be_merged(): void
    {
        ...
        $response = $this->http->get(
            uri([TestController::class, "testCanMergeProps"]),
            headers: [
                Header::INERTIA => "true",
                Header::VERSION => $version,
    ...
    public function test_array_helper_props_can_be_resolved(): void
    {
        ...
        $response = $this->http->get(
            uri([TestController::class, "testAllSortsOfProps"]),
            headers: [
                Header::INERTIA => "true",
                Header::VERSION => $version,
